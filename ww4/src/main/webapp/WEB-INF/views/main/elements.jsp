...
<link rel="stylesheet" href="/resources/css/template.css?v=0" type="text/css" media="all">
</head>
<body class="is-preload">

	<!-- Header -->
	<header id="header">
		<a class="logo" href="/main3">Industrious</a>
		<nav>
			<a href="#menu">Menu</a>
		</nav>
	</header>
	...
	<nav id="menu">
		<ul class="links">
			<li><a href="/main3">Home</a></li>
			<li><a href="/main3e">Elements</a></li>
			<li><a href="/main3g">Generic</a></li>
		</ul>
	</nav>
				...
				<div class="row">
					<div class="col-6 col-12-medium">
						...
						<p>Nunc lacinia ante nunc ac lobortis. Interdum adipiscing
							...
							sapien lorem accumsan varius montes viverra nibh in adipiscing.</p>
						...
						<ul class="icons">
							...
							<li><a href="#" class="icon fa-apple"><span
									class="label">Apple</span></a></li>
							<li><a href="#" class="icon fa-windows"><span
									class="label">Windows</span></a></li>
							<li><a href="#" class="icon fa-500px"><span
						...
						<!-- Blockquote -->
						<h3>Blockquote</h3>
						<blockquote>Nunc lacinia ante nunc ac lobortis.
							Interdum adipiscing gravida odio porttitor sem non mi integer non
							faucibus ornare mi ut ante amet placerat aliquet. Volutpat eu sed
							ante lacinia sapien lorem accumsan varius montes viverra. Lorem
							...
							ante nunc ac gravida.</blockquote>
					...
					<div class="col-6 col-12-medium">
						...
						<form method="post" action="#">
							<div class="row gtr-uniform">
								...
								<div class="col-4 col-12-small">
									<input type="radio" id="radio-beta" name="radio"> <label
										for="radio-beta">Radio beta</label>
								</div>
								<div class="col-4 col-12-small">
									<input type="radio" id="radio-gamma" name="radio"> <label
										for="radio-gamma">Radio gamma</label>
								</div>
								<!-- Break -->
								<div class="col-6 col-12-small">
								...
								<div class="col-6 col-12-small">
									<input type="checkbox" id="checkbox-beta" name="checkbox"
										checked> <label for="checkbox-beta">Checkbox
										beta</label>
								</div>
								<!-- Break -->
								<div class="col-12">
									<textarea name="textarea" id="textarea"
										placeholder="Alpha beta gamma delta" rows="6"></textarea>
								</div>
								<!-- Break -->
								<div class="col-12">
									<ul class="actions">
						...
						<p>
							...
							tincidunt felis sagittis eget. tempus euismod. Magna et cursus
							lorem faucibus vestibulum. Blandit adipiscing eu felis iaculis
							volutpat ac adipiscing accumsan eu faucibus. Integer ac
							pellentesque praesent tincidunt felis sagittis eget. tempus
							euismod tempus. Vestibulum ante ipsum primis in faucibus
							...
							sed amet praesent. Nunc lacinia ante nunc ac gravida lorem ipsum
							dolor sit amet dolor feugiat consequat.
						</p>
						<p>
