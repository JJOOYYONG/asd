...
<html lang="en">
  <head>
    <title>Glint Studio &mdash; Onepage Website Template by Free-Template.co</title>
    <meta charset="utf-8">
    ...
    <link rel="shortcut icon" href="/resources/glint/ftco-32x32.png">

    <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900" rel="stylesheet">
    <link rel="stylesheet" href="/resources/glint/fonts/icomoon/style.css">
    <link rel="stylesheet" href="/resources/glint/css/bootstrap.min.css">
    <link rel="stylesheet" href="/resources/glint/css/animate.css">
    <link rel="stylesheet" href="/resources/glint/css/owl.carousel.min.css">
    <link rel="stylesheet" href="/resources/glint/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="/resources/glint/css/bootstrap-datepicker.css">
    
    
    <link rel="stylesheet" href="/resources/glint/fonts/flaticon/font/flaticon.css">
  
    <link rel="stylesheet" href="/resources/glint/css/aos.css">
    <link rel="stylesheet" href="/resources/glint/css/jquery.fancybox.min.css">
    

    <link rel="stylesheet" href="/resources/glint/css/style.css">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-6 col-md-4">
              <h1 class="my-0 site-logo"><a href="index.html">Glint Studio<span class="text-primary">.</span> </a></h1>
            </div>
    ...
    <div class="site-blocks-cover" id="home-section">
      <div class="img-wrap">
        <div class="owl-carousel slide-one-item hero-slider">
          <div class="slide">
            <img src="/resources/glint/images/glint_hero_1.jpg" alt="Free Website Template by Free-Template.co">  
          </div>
          <div class="slide">
            <img src="/resources/glint/images/glint_hero_2.jpg" alt="Free Website Template by Free-Template.co">  
          </div>
          <div class="slide">
            <img src="/resources/glint/images/glint_hero_3.jpg" alt="Free Website Template by Free-Template.co">  
          </div>
        </div>
      </div>
      <div class="container">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mb-5">
            <img src="/resources/glint/images/glint_about_1.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
          </div>
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          <div class="col-lg-6 mb-5 person">
            <img src="/resources/glint/images/person_1.jpg" alt="Free website template by Free-Template.co" class="img-fluid mb-5">
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-lg-6 mb-4 mb-lg-0">
            <img src="/resources/glint/images/sq_img_2.jpg" alt="Free website template by Free-Template.co" class="img-fluid">
          </div>
            ...
            <div class="testimonial bg-white h-100">
              ...
              <div class="d-flex align-items-center vcard">
                <figure class="mb-0 mr-3">
                  <img src="/resources/glint/images/person_3.jpg" alt="Free website template by Free-Template.co" class="img-fluid ounded-circle">
                </figure>
        ...
        <div class="row mb-5">
          <div class="col-lg-6 order-1 order-lg-2 mb-4 mb-lg-0">
            <img src="/resources/glint/images/sq_img_4.jpg" alt="Free website template by Free-Template.co" class="img-fluid">
          </div>
          <div class="col-lg-5 h-100 jm-sticky-top mr-auto order-2 order-lg-1">
            ...
            <div class="testimonial bg-white h-100">
              ...
              <div class="d-flex align-items-center vcard">
                <figure class="mb-0 mr-3">
                  <img src="/resources/glint/images/person_4.jpg" alt="Free website template by Free-Template.co" class="img-fluid ounded-circle">
                </figure>
                <div class="vcard-text">
...
<footer class="site-footer">
  ...
  <script src="/resources/glint/js/jquery-3.3.1.min.js"></script>
  <script src="/resources/glint/js/popper.min.js"></script>
  <script src="/resources/glint/js/bootstrap.min.js"></script>
  <script src="/resources/glint/js/owl.carousel.min.js"></script>
  <script src="/resources/glint/js/aos.js"></script>
  <script src="/resources/glint/js/jquery.sticky.js"></script>
  <script src="/resources/glint/js/stickyfill.min.js"></script>
  <script src="/resources/glint/js/jquery.easing.1.3.js"></script>
  <script src="/resources/glint/js/isotope.pkgd.min.js"></script>
  
  <script src="/resources/glint/js/jquery.fancybox.min.js"></script>
  <script src="/resources/glint/js/main.js"></script>
