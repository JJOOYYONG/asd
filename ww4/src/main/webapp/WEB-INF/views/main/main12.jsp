    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="mobile-nav">
            ...
            <div class="amado-navbar-brand">
                <a href="/main12"><img src="/resources/amado/img/core-img/logo.png" alt=""></a>
            </div>
            <!-- Navbar Toggler -->
        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    <li class="active"><a href="/main12">Home</a></li>
                    <li><a href="/resources/amado/shop.html">Shop</a></li>
                    <li><a href="/resources/amado/product-details.html">Product</a></li>
                    <li><a href="/resources/amado/cart.html">Cart</a></li>
                    <li><a href="/resources/amado/checkout.html">Checkout</a></li>
                </ul>
            </nav>
            <!-- Button Group -->
            ...
            <div class="cart-fav-search mb-100">
                <a href="/resources/amado/cart.html" class="cart-nav"><img src="/resources/amado/img/core-img/cart.png" alt=""> Cart <span>(0)</span></a>
        ...
        <div class="products-catagories-area clearfix">
            <div class="amado-pro-catagory clearfix">
                ...
                <div class="single-products-catagory clearfix">
                    <a href="/resources/amado/shop.html">
                        <img src="/resources/amado/img/bg-img/1.jpg" alt="">
                        <!-- Hover Content -->
                ...
                <div class="col-12 col-lg-4">
                    <div class="single_widget_area">
                        ...
                        <div class="footer-logo mr-50">
                            <a href="/main12"><img src="/resources/amado/img/core-img/logo2.png" alt=""></a>
                        </div>
                        <!-- Copywrite Text -->
                                ...
                                <div class="collapse navbar-collapse" id="footerNavContent">
                                    <ul class="navbar-nav ml-auto">
                                        <li class="nav-item active">
                                            <a class="nav-link" href="/main12">Home</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/resources/amado/shop.html">Shop</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/resources/amado/product-details.html">Product</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/resources/amado/cart.html">Cart</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/resources/amado/checkout.html">Checkout</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
